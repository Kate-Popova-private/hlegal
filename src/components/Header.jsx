...
import hLogoName_dark from "../img/hLogoName_dark.svg";
...
const Header = () => {
    ...
    return (
        <>
            <header className={`header ${headerTheme === 'color-white'?'header__remove':''}`}>
                <div className="header__container">
                    <div className={`header__language language language_${headerTheme}`}>
                        <span className={`language__item language__item_${headerTheme}`}>УК</span>
                        <span className={`language__item language__item_${headerTheme}`}>РУ</span>
                        <span className={`language__item language__item_${headerTheme}`}>EN</span>
                    </div>
                ...
                <div className="header__container">
                    <Link to="/" className="header__logo logo"><img className="header__logo-img" src={headerTheme === 'color-dark'?  hLogoName : hLogoName_dark} alt="hlegal"/>
